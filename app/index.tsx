    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.primarybg }}>
      ...
      <View style={tw`flex-1 justify-between`}>
        ...
        <Animatable.View
          ...
          easing="ease-in-out"
          delay={300}
          style={[tw`flex-1 justify-center items-center pt-5`, { backgroundColor: Colors.primarybg }]}
        >
          <Image
        ...
        {/* Content Section */}
        <View
          style={[tw`flex-1 justify-center px-4`, { borderTopLeftRadius: 50, borderTopRightRadius: 50, overflow: "hidden" }]}
        >
          <TouchableOpacity
         ...
         <TouchableOpacity>
           ...
           <Animatable.View 
            ...
            duration={1500}
            easing="ease-in-out"
            style={tw`absolute right-6 bottom-0`}
          >
            <Image 
